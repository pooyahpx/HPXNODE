...
func Load() (*Config, error) {
	...
	cfg := &Config{
		...
		SslCertFile:                 GetEnv("SSL_CERT_FILE", "/var/lib/hpx-node/certs/ssl_cert.pem"),
		SslKeyFile:                  GetEnv("SSL_KEY_FILE", "/var/lib/hpx-node/certs/ssl_key.pem"),
		GeneratedConfigPath:         GetEnv("GENERATED_CONFIG_PATH", "/var/lib/hpx-node/generated/"),
