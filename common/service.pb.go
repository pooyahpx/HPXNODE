...
const (
	...
	BackendType_PPTP        BackendType = 5
	BackendType_OPENCONNECT BackendType = 6
	BackendType_SSTP        BackendType = 7
	BackendType_WG_C        BackendType = 8
	BackendType_AMNEZIAWG   BackendType = 9
	BackendType_GRE         BackendType = 10
	BackendType_SSH         BackendType = 11
	BackendType_MTPROTO     BackendType = 12
)
...
// Username/password credentials for PPTP / OpenConnect / SSTP / SSH.
...
func (x *Gre) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Gre) ProtoMessage() {}

func (x *Gre) ProtoReflect() protoreflect.Message {
	mi := &file_common_service_proto_msgTypes[23]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (x *AnyTLS) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AnyTLS) ProtoMessage() {}

func (x *AnyTLS) ProtoReflect() protoreflect.Message {
	mi := &file_common_service_proto_msgTypes[25]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AnyTLS.ProtoReflect.Descriptor instead.
func (*AnyTLS) Descriptor() ([]byte, []int) {
	return file_common_service_proto_rawDescGZIP(), []int{25}
}

func (x *AnyTLS) GetPassword() string {
	if x != nil {
		return x.Password
	}
	return ""
...
func (x *Naive) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Naive) ProtoMessage() {}

func (x *Naive) ProtoReflect() protoreflect.Message {
	mi := &file_common_service_proto_msgTypes[27]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Naive.ProtoReflect.Descriptor instead.
func (*Naive) Descriptor() ([]byte, []int) {
	return file_common_service_proto_rawDescGZIP(), []int{27}
}

func (x *Naive) GetUsername() string {
	if x != nil {
		return x.Username
	}
	return ""
...
func (x *Naive) GetPassword() string {
	if x != nil {
		return x.Password
	}
	return ""
...
type Proxy struct {
	...
	Pptp          *Credential            `protobuf:"bytes,9,opt,name=pptp,proto3" json:"pptp,omitempty"`
	Openconnect   *Credential            `protobuf:"bytes,10,opt,name=openconnect,proto3" json:"openconnect,omitempty"`
	Sstp          *Credential            `protobuf:"bytes,11,opt,name=sstp,proto3" json:"sstp,omitempty"`
	Ssh           *Credential            `protobuf:"bytes,12,opt,name=ssh,proto3" json:"ssh,omitempty"`
	WgC           *Wireguard             `protobuf:"bytes,13,opt,name=wg_c,json=wgC,proto3" json:"wg_c,omitempty"`
	Amneziawg     *Wireguard             `protobuf:"bytes,14,opt,name=amneziawg,proto3" json:"amneziawg,omitempty"`
	Gre           *Gre                   `protobuf:"bytes,15,opt,name=gre,proto3" json:"gre,omitempty"`
	Mtproto       *Mtproto               `protobuf:"bytes,16,opt,name=mtproto,proto3" json:"mtproto,omitempty"`
	Anytls        *AnyTLS                `protobuf:"bytes,17,opt,name=anytls,proto3" json:"anytls,omitempty"`
	Tuic          *Tuic                  `protobuf:"bytes,18,opt,name=tuic,proto3" json:"tuic,omitempty"`
	Naive         *Naive                 `protobuf:"bytes,19,opt,name=naive,proto3" json:"naive,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Proxy) GetPptp() *Credential {
	if x != nil {
		return x.Pptp
	}
	return nil
...
func (x *Proxy) GetOpenconnect() *Credential {
	if x != nil {
		return x.Openconnect
	}
	return nil
}

func (x *Proxy) GetSstp() *Credential {
	if x != nil {
		return x.Sstp
	}
	return nil
...
func (x *Proxy) GetSsh() *Credential {
	if x != nil {
		return x.Ssh
	}
	return nil
...
func (x *Proxy) GetAmneziawg() *Wireguard {
	if x != nil {
		return x.Amneziawg
	}
	return nil
...
const file_common_service_proto_rawDesc = "" +
	...
	"\x03Gre\x12\x17\n" +
	"\apeer_ip\x18\x01 \x01(\tR\x06peerIp\"!\n" +
	"\aMtproto\x12\x16\n" +
	...
	"\x05Naive\x12\x1a\n" +
	"\busername\x18\x01 \x01(\tR\busername\x12\x1a\n" +
	"\bpassword\x18\x02 \x01(\tR\bpassword\"\xae\x06\n" +
	"\x05Proxy\x12$\n" +
	...
	"\x05ikev2\x18\b \x01(\v2\x0e.service.Ikev2R\x05ikev2\x12'\n" +
	"\x04pptp\x18\t \x01(\v2\x13.service.CredentialR\x04pptp\x125\n" +
	"\vopenconnect\x18\n" +
	" \x01(\v2\x13.service.CredentialR\vopenconnect\x12'\n" +
	"\x04sstp\x18\v \x01(\v2\x13.service.CredentialR\x04sstp\x12%\n" +
	"\x03ssh\x18\f \x01(\v2\x13.service.CredentialR\x03ssh\x12%\n" +
	"\x04wg_c\x18\r \x01(\v2\x12.service.WireguardR\x03wgC\x120\n" +
	"\tamneziawg\x18\x0e \x01(\v2\x12.service.WireguardR\tamneziawg\x12\x1e\n" +
	"\x03gre\x18\x0f \x01(\v2\f.service.GreR\x03gre\x12*\n" +
	"\amtproto\x18\x10 \x01(\v2\x10.service.MtprotoR\amtproto\x12'\n" +
	"\x06anytls\x18\x11 \x01(\v2\x0f.service.AnyTLSR\x06anytls\x12!\n" +
	"\x04tuic\x18\x12 \x01(\v2\r.service.TuicR\x04tuic\x12$\n" +
	"\x05naive\x18\x13 \x01(\v2\x0e.service.NaiveR\x05naive\"\x9e\x01\n" +
	"\x04User\x12\x14\n" +
	...
	"\x04last\x18\x03 \x01(\bR\x04last*\xa5\x01\n" +
	"\vBackendType\x12\b\n" +
	"\x04XRAY\x10\x00\x12\r\n" +
	"\tWIREGUARD\x10\x01\x12\v\n" +
	"\aOPENVPN\x10\x02\x12\t\n" +
	"\x05IKEV2\x10\x03\x12\b\n" +
	"\x04L2TP\x10\x04\x12\b\n" +
	"\x04PPTP\x10\x05\x12\x0f\n" +
	"\vOPENCONNECT\x10\x06\x12\b\n" +
	"\x04SSTP\x10\a\x12\b\n" +
	"\x04WG_C\x10\b\x12\r\n" +
	"\tAMNEZIAWG\x10\t\x12\a\n" +
	"\x03GRE\x10\n" +
...
var file_common_service_proto_goTypes = []any{
	...
	(*Credential)(nil),                // 24: service.Credential
	(*Gre)(nil),                       // 25: service.Gre
	(*Mtproto)(nil),                   // 26: service.Mtproto
	(*AnyTLS)(nil),                    // 27: service.AnyTLS
	(*Tuic)(nil),                      // 28: service.Tuic
	(*Naive)(nil),                     // 29: service.Naive
	(*Proxy)(nil),                     // 30: service.Proxy
	(*User)(nil),                      // 31: service.User
	(*Users)(nil),                     // 32: service.Users
	(*UsersChunk)(nil),                // 33: service.UsersChunk
	nil,                               // 34: service.BaseInfoResponse.BackendVersionsEntry
	nil,                               // 35: service.StatsOnlineIpListResponse.IpsEntry
	nil,                               // 36: service.StatsOnlineIpListResponse.IpProtocolEntry
}
var file_common_service_proto_depIdxs = []int32{
	0,  // 0: service.BaseInfoResponse.available_backends:type_name -> service.BackendType
	34, // 1: service.BaseInfoResponse.backend_versions:type_name -> service.BaseInfoResponse.BackendVersionsEntry
	0,  // 2: service.Backend.type:type_name -> service.BackendType
	31, // 3: service.Backend.users:type_name -> service.User
	6,  // 4: service.StatResponse.stats:type_name -> service.Stat
	1,  // 5: service.StatRequest.type:type_name -> service.StatType
	35, // 6: service.StatsOnlineIpListResponse.ips:type_name -> service.StatsOnlineIpListResponse.IpsEntry
	36, // 7: service.StatsOnlineIpListResponse.ip_protocol:type_name -> service.StatsOnlineIpListResponse.IpProtocolEntry
	...
	24, // 17: service.Proxy.pptp:type_name -> service.Credential
	24, // 18: service.Proxy.openconnect:type_name -> service.Credential
	24, // 19: service.Proxy.sstp:type_name -> service.Credential
	24, // 20: service.Proxy.ssh:type_name -> service.Credential
	20, // 21: service.Proxy.wg_c:type_name -> service.Wireguard
	20, // 22: service.Proxy.amneziawg:type_name -> service.Wireguard
	25, // 23: service.Proxy.gre:type_name -> service.Gre
	26, // 24: service.Proxy.mtproto:type_name -> service.Mtproto
	27, // 25: service.Proxy.anytls:type_name -> service.AnyTLS
	28, // 26: service.Proxy.tuic:type_name -> service.Tuic
	29, // 27: service.Proxy.naive:type_name -> service.Naive
	30, // 28: service.User.proxies:type_name -> service.Proxy
	31, // 29: service.Users.users:type_name -> service.User
	31, // 30: service.UsersChunk.users:type_name -> service.User
	4,  // 31: service.NodeService.Start:input_type -> service.Backend
	2,  // 32: service.NodeService.Stop:input_type -> service.Empty
	2,  // 33: service.NodeService.GetBaseInfo:input_type -> service.Empty
	2,  // 34: service.NodeService.GetLogs:input_type -> service.Empty
	2,  // 35: service.NodeService.GetSystemStats:input_type -> service.Empty
	2,  // 36: service.NodeService.GetBackendStats:input_type -> service.Empty
	8,  // 37: service.NodeService.GetStats:input_type -> service.StatRequest
	12, // 38: service.NodeService.GetOutboundsLatency:input_type -> service.LatencyRequest
	8,  // 39: service.NodeService.GetUserOnlineStats:input_type -> service.StatRequest
	8,  // 40: service.NodeService.GetUserOnlineIpListStats:input_type -> service.StatRequest
	31, // 41: service.NodeService.SyncUser:input_type -> service.User
	32, // 42: service.NodeService.SyncUsers:input_type -> service.Users
	33, // 43: service.NodeService.SyncUsersChunked:input_type -> service.UsersChunk
	3,  // 44: service.NodeService.Start:output_type -> service.BaseInfoResponse
	2,  // 45: service.NodeService.Stop:output_type -> service.Empty
	3,  // 46: service.NodeService.GetBaseInfo:output_type -> service.BaseInfoResponse
	5,  // 47: service.NodeService.GetLogs:output_type -> service.Log
	15, // 48: service.NodeService.GetSystemStats:output_type -> service.SystemStatsResponse
	14, // 49: service.NodeService.GetBackendStats:output_type -> service.BackendStatsResponse
	7,  // 50: service.NodeService.GetStats:output_type -> service.StatResponse
	13, // 51: service.NodeService.GetOutboundsLatency:output_type -> service.LatencyResponse
	9,  // 52: service.NodeService.GetUserOnlineStats:output_type -> service.OnlineStatResponse
	10, // 53: service.NodeService.GetUserOnlineIpListStats:output_type -> service.StatsOnlineIpListResponse
	2,  // 54: service.NodeService.SyncUser:output_type -> service.Empty
	2,  // 55: service.NodeService.SyncUsers:output_type -> service.Empty
	2,  // 56: service.NodeService.SyncUsersChunked:output_type -> service.Empty
