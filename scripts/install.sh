#!/usr/bin/env bash
#
# HPXPANEL Node Ã¢â‚¬â€ command-deck edge installer
# ------------------------------------------
...
# you paste into HPXPANEL Ã¢â€ â€™ Nodes.
#
# One-liner (Linux):
...
#
# Local:
#   sudo bash scripts/install.sh install -y
#   sudo bash scripts/install.sh menu
#
set -euo pipefail

# When invoked as: bash -c "$(curl Ã¢â‚¬Â¦)" @ install Ã¢â‚¬Â¦
# the "@" is $0-style arg noise from one-liners Ã¢â‚¬â€ strip it.
if [ "${1:-}" = "@" ]; then shift; fi
...
die()  { err "$*"; exit 1; }
hr()   { echo -e "${c_cyn}Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬${c_off}"; }
...
run_step() {
  local msg="$1"; shift
  echo -ne "  ${c_cyn}Ã¢â€“Â¶${c_off} ${msg} ${c_dim}...${c_off} "
...
_rule() { echo -e "${c_dim}    Ã¢â€â€žÃ¢â€â€žÃ¢â€â€žÃ¢â€â€žÃ¢â€â€žÃ¢â€â€žÃ¢â€â€žÃ¢â€â€žÃ¢â€â€žÃ¢â€â€žÃ¢â€â€žÃ¢â€â€žÃ¢â€â€žÃ¢â€â€žÃ¢â€â€žÃ¢â€â€žÃ¢â€â€žÃ¢â€â€žÃ¢â€â€žÃ¢â€â€žÃ¢â€â€žÃ¢â€â€žÃ¢â€â€žÃ¢â€â€žÃ¢â€â€žÃ¢â€â€žÃ¢â€â€žÃ¢â€â€žÃ¢â€â€žÃ¢â€â€žÃ¢â€â€žÃ¢â€â€žÃ¢â€â€žÃ¢â€â€žÃ¢â€â€žÃ¢â€â€žÃ¢â€â€žÃ¢â€â€žÃ¢â€â€žÃ¢â€â€žÃ¢â€â€žÃ¢â€â€žÃ¢â€â€žÃ¢â€â€žÃ¢â€â€žÃ¢â€â€žÃ¢â€â€žÃ¢â€â€ž${c_off}"; }
...
run_step_live() {
  ...
  echo -e "  ${c_cyn}Ã¢â€“Â¶${c_off} ${c_bld}${msg}${c_off}"
  _rule
  if _stream "$@"; then
    _rule; echo -e "  ${c_grn}Ã¢Å“â€${c_off} ${msg}"
  else
    _rule; echo -e "  ${c_red}Ã¢Å“Ëœ${c_off} ${msg}"
...
run_step_live_soft() {
  ...
  _rule
  if _stream "$@"; then
    echo -e "  ${c_grn}Ã¢Å“â€${c_off} ${msg}"; return 0
  else
    echo -e "  ${c_yel}Ã¢â€“Â·${c_off} ${msg} Ã¢â‚¬â€ ${c_yel}skipped${c_off}"; return 1
  fi
}
...
wait_for_apt() {
  ...
  log "apt/dpkg is busy ($(apt_holder)) Ã¢â‚¬â€ waiting up to $((max / 60))m..."
  while apt_busy; do
...
install_docker() {
  if ! has docker; then
    wait_for_apt || die "apt is locked Ã¢â‚¬â€ retry later"
...
banner() {
  ...
  echo
  echo -e "  ${c_cyn}${c_bld}Ã¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€â€œ${c_off}"
  echo -e "  ${c_cyn}${c_bld}Ã¢â€Æ’${c_off}  ${c_amb}${c_bld}HPX${c_off}${c_bld}PANEL${c_off}  ${c_dim}//${c_off}  ${c_cyn}NODE DEPLOY${c_off}  ${c_dim}Ã‚Â· COMMAND DECK${c_off}     ${c_cyn}${c_bld}Ã¢â€Æ’${c_off}"
  echo -e "  ${c_cyn}${c_bld}Ã¢â€â€”Ã¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€â€º${c_off}"
  echo
  echo -e "  ${c_dim}Edge node for${c_off} ${c_bld}HPXPANEL${c_off} ${c_dim}Ã¢â‚¬â€ paste Address / Port / API key / CA into the panel.${c_off}"
  echo
}

features_panel() {
  echo -e "  ${c_bld}HPX NODE CAPABILITIES${c_off}"
  echo -e "  ${c_dim}Ã¢â€Å’Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€Â${c_off}"
  echo -e "  ${c_dim}Ã¢â€â€š${c_off}  ${c_cyn}Ã¢â€”â€ ${c_off} Xray stack     ${c_dim}VLESS / VMess / Trojan / SS / REALITY${c_off}"
  echo -e "  ${c_dim}Ã¢â€â€š${c_off}  ${c_cyn}Ã¢â€”â€ ${c_off} WireGuard      ${c_dim}kernel WG + host NAT routing${c_off}"
  echo -e "  ${c_dim}Ã¢â€â€š${c_off}  ${c_cyn}Ã¢â€”â€ ${c_off} OpenVPN        ${c_dim}optional tunnel backend${c_off}"
  echo -e "  ${c_dim}Ã¢â€â€š${c_off}  ${c_amb}Ã¢â€”â€ ${c_off} IKEv2 / IPsec  ${c_dim}native strongSwan (HPX special)${c_off}"
  echo -e "  ${c_dim}Ã¢â€â€š${c_off}  ${c_grn}Ã¢â€”â€ ${c_off} Panel sync     ${c_dim}gRPC Ã¢â€ â€™ HPXPANEL Nodes UI${c_off}"
  echo -e "  ${c_dim}Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€Ëœ${c_off}"
  echo
}

usage() {
  cat <<EOF
HPXPANEL Node Ã¢â‚¬â€ Docker installer (hpx-node)

Usage:
  sudo bash hpx-node.sh [command] [options]
  sudo bash -c "\$(curl -fsSL ${PANEL_REPO}/raw/main/scripts/install.sh)" @ install -y
...
onoff() { if [ "${1:-0}" -eq 1 ]; then echo -e "${c_grn}${c_bld}Ã¢â€”Â ON${c_off}"; else echo -e "${c_dim}Ã¢â€”â€¹ off${c_off}"; fi; }
press_enter() { echo; _read -r -p "$(echo -e "  ${c_dim}Press Enter to return to the deckÃ¢â‚¬Â¦${c_off}")" _; }

menu_command() {
  require_root
  if [ ! -e /dev/tty ] && [ ! -t 0 ]; then
    die "no terminal for the menu Ã¢â‚¬â€ use:
  sudo bash install.sh install --disable openvpn -y"
  fi
  ...
  while true; do
    ...
    echo
    local choice
    _read -r -p "$(echo -e "  ${c_bld}Select${c_off} ${c_dim}(number / letter)${c_off} ${c_amb}Ã¢ÂÂ¯${c_off} ")" choice
    case "$choice" in
      1) XRAY_ON=$((1 - XRAY_ON)) ;;
      2) OVPN_ON=$((1 - OVPN_ON)) ;;
      3) WG_ON=$((1 - WG_ON)) ;;
      4) IKEV2_ON=$((1 - IKEV2_ON)) ;;
      5) SERVICE_PORT="$(ask_num "Node port (gRPC Ã¢â‚¬â€ panel Node Port)" "$SERVICE_PORT")" ;;
...
print_summary() {
  ...
  echo
  echo -e "  ${c_cyn}Ã¢â€“Â¶${c_off} ${c_bld}Waiting for Server CA${c_off} ${c_dim}(first boot)${c_off}"
  ...
  echo
  echo -e "  ${c_amb}${c_bld}Ã¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€â€œ${c_off}"
  echo -e "  ${c_amb}${c_bld}Ã¢â€Æ’${c_off}  ${c_grn}${c_bld}HPX NODE ONLINE${c_off}  ${c_dim}Ã¢â‚¬â€ register in HPXPANEL Ã¢â€ â€™ Nodes${c_off}   ${c_amb}${c_bld}Ã¢â€Æ’${c_off}"
  echo -e "  ${c_amb}${c_bld}Ã¢â€â€”Ã¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€ÂÃ¢â€â€º${c_off}"
  echo
  ...
  if [ -n "$ca" ]; then
    ...
    warn "Server CA not ready yet Ã¢â‚¬â€ run:"
...
#!/usr/bin/env bash
exec bash -c "\$(curl -fsSL ${PANEL_REPO}/raw/main/scripts/install.sh 2>/dev/null || cat ${INSTALL_DIR}/hpx-node.sh 2>/dev/null)" @ "\$@"
EOF
...
run_install() {
  ...
  local quiet_note=""; [ "${QUIET:-0}" = "1" ] && quiet_note=" Ã¢â‚¬â€ quiet mode"
  ...
  if [ "$BUILD_FROM_SOURCE" = 0 ]; then
    if ! run_step_live_soft "Pulling image ${IMAGE}" pull_image; then
      if [ "$IMAGE" != "$FALLBACK_IMAGE" ]; then
        warn "primary image failed Ã¢â‚¬â€ trying fallback ${FALLBACK_IMAGE}"
        IMAGE="$FALLBACK_IMAGE"
        run_step "Rewriting compose for fallback" write_compose
        if ! run_step_live_soft "Pulling fallback ${IMAGE}" pull_image; then
          warn "pull failed Ã¢â‚¬â€ building from source (takes a few minutes)"
          BUILD_FROM_SOURCE=1
          run_step "Rewriting compose for build" write_compose
        fi
      else
        warn "image pull failed Ã¢â‚¬â€ building from source"
        BUILD_FROM_SOURCE=1
        run_step "Rewriting compose for build" write_compose
      fi
    fi
...
need_compose() {
  detect_compose || { warn "Docker / compose not found Ã¢â‚¬â€ install first."; return 1; }
